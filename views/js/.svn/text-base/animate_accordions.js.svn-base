 ...
 */
M.blocks_assmgr_animate_accordions = {
    // params from PHP
    open_image : null,
    closed_image : null,
    ...
    init : function(Y, open_image, closed_image) {
		...
		var headers = Dom.getElementsByClassName('headingblock', 'h2');
		...
		// suppress the onclick event for all help buttons from firing on their parent elements
		helplinks = Dom.getElementsByClassName('helplink', 'span');

...
class moodle2_db_emulator {
    ...
    function __call($method, $params) {
        ...
        return assmgr_db::encode(call_user_func_array($method, $params));
    }
...
class moodle2_renderer_emulator {
    ...
    function header() {
        ...
        return print_header_simple($PAGE->title, '', $PAGE->set_navigation, '', $this->requires->meta);
    }
...
class moodle2_page_requires {
     ...
     */
    function assmgr_add_custom_header($custom_header) {
